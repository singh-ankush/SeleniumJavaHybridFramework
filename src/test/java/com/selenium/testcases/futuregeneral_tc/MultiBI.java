...
public class MultiBI extends TestBase {
    ...
    public static HashMap<String, List<HashMap<String, String>>> dataMap =
            DataReader.testDataMappedWithMultipleRows(prop.getProperty("TestDataExcelFileName_fg"), prop.getProperty("TestDataSheetName_fg"));
...
//        _createBI = new com.selenium.pages.futuregeneral.CreateBI();
    ...
    public void create_BI(){
        ...
        List<HashMap<String, String>> multiBIdata = dataMap.get("BI");

        for (HashMap<String, String> data : multiBIdata) {
